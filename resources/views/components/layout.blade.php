...
<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        <a href="/"><img class="w-16 rounded m-2" src="{{ asset('images/logo.png') }}" alt=""
                class="logo" /></a>
    ...
    <footer
        ...
        <a href="/listings/create" class="absolute top-1/4 rounded right-10 bg-black text-white py-2 px-5">Post Job</a>
    </footer>
